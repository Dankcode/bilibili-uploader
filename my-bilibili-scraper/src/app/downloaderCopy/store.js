...
export const useSettingStore = create((set) => ({
  downloadPath: '',
  SESSDATA: '***REMOVED***-9BH_eDmCkxnpR2YIV0-rtAasnOU3KAAFEKK-1K6csAQJ-mYVK8MO-Xy4kSVkJNN3M3OGNxS1B0TjlUTllIekRFUmhIdWhxUnVreWxhN3l3SFlPUm1Ub29FZEhoOVBjWlk3RV8wM0NqOUZsRUN2V2NtSFpNaEk2SzQxMEhRcWlJdHN3IIEC',
  isMerge: true,
  isDelete: true,
  bfeId: '',
  isSubtitle: true,
